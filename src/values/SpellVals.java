...
public abstract class SpellVals {
	...
	public static int skill_fireball_damage = -(Player.LV * 4 + 100);

	// Mana Cost Values
	public static int fireball_mana = 50;
	public static int iceball_mana = 60;
	public static int skill_fireball_mana = 50;
	...
	public static int skill_fireball_time = 30;

	public static void redim() {
		// Damage Values
		fireball_damage = -(Player.LV * 4 + 50);
		iceball_damage = -(Player.LV * 4 + 35);
		skill_fireball_damage = -(Player.LV * 4 + 100);

		// Mana Cost Values
		fireball_mana = 50;
		iceball_mana = 60;
		skill_fireball_mana = 50;

		// Range Values
		fireball_range = 50;
		iceball_range = 75;
		skill_fireball_range = 50;
